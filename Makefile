...
cmdReader: main.o cmdReader.o cmdCharDef.o
	$(CC) -o $@ $(MAKEFLAGS) main.o cmdReader.o cmdCharDef.o
#	strip $@

testAsc: testAsc.o cmdCharDef.o
	$(CC) -o $@ $(MAKEFLAGS) testAsc.o cmdCharDef.o
	strip $@

cmdReader-ref: main.o cmdReader.o.ref cmdCharDef.o
	$(CC) -o $@ $(MAKEFLAGS) main.o cmdReader.o.ref cmdCharDef.o
	strip $@
